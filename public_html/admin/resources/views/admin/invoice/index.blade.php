                ...
                <div class="col-12 col-md-12">
                    <div class="card card-outline card-orange">
                        <div class="card-header bg-primary">
                            <h3 class="card-title"><i class="fa fa-bank"></i> &nbsp; View Invoice ({{ $data[0]['clint_name'] ?? ''}})</h3>
                            <div class="card-tools">
                                <a href="{{url('admin/invoice')}}/{{$id}}" class="btn btn-warning text-white btn-sm"><i
                            ...
                            <div class="table-responsive mb-4">
                                <table id="example1" class="table table-centered table-nowrap mb-0 ">
                                 ...
                                 <td> {{ $FetchData->date ?? ''}} </td>									
									...
									<td>
									    @if($FetchData->payment_type == 'Payment')
									    {{ $FetchData->amount ?? ''}}
									    @else
									    -
									    @endif
								...
								<!--	<td>
                                          <a href="{{url('admin/invoice_details')}}/{{$FetchData['website_amc_id'] ?? ''}}"><button type="button" class="btn btn-success btn-sm mt-0" ><i class="fa fa-search"></i></button></a>
               						</td>-->
