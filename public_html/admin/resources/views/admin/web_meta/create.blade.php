                            ...
                            <div class="row m-2">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select name="page_name" id="page_name" class="form-control teg @error('page_name') is-invalid @enderror mt-1" >
                                               @if(!empty(getwebmeta())) 
                                            @foreach(getwebmeta() as $getwebmeta)
                                                <option value="{{ $getwebmeta->id ?? ''  }}" {{ ( $getwebmeta['id'] == old('page_name')) ? 'selected' : '' }}>{{ $getwebmeta->page_name ?? ''  }}</option>
                                            @endforeach
                                        @endif
                                        </select> 
                                    </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('tittle') is-invalid @enderror" id="tittle" name="tittle" placeholder="Tittle" value=""required>
                                        @error('tittle')
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('meta_kyewords') is-invalid @enderror" id="meta_kyewords" name="meta_kyewords" placeholder="Meta keywords" value=""required>
                                        @error('meta_kyewords')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('meta_description') is-invalid @enderror" id="meta_description" name="meta_description" placeholder="Meta Description" value="" required>
                            ...
                            <div class="row m-2">
                                <div class="col-md-4 mt-2">
                                    ...
                                    <div class="check-box mt-2">
                                     <input value="1"  name="status" type="checkbox" id="switch1" switch="none" {{ ( ['status'] == 1) ? 'checked' : '' }} />
                                    </div>
                                    @error('name')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
