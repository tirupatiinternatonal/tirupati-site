                ...
                <div class="col-12 col-md-12">
                    <div class="card card-outline card-orange">
                        <div class="card-header bg-primary">
                            <h3 class="card-title"><i class="fa fa-truck"></i> &nbsp; Shipping Policy </h3>
                          ...
                          {!! Form::model($setting, ['method' => 'PATCH','files' => true,'route' => ['admin.shipping_policy.update', $setting->id]]) !!}
                           @csrf
                            <div class="row m-2">
                                <div class="col-md-12 Label_top">
                                    <label for="Username">Shipping Policy</label>
                                    <textarea  class="form-control ckeditor" name="shipping_policy">{{$setting['shipping_policy'] ?? ''}}</textarea>
                		        </div>
