...
') }}
                            ...
                            <div class="card-tools">
                                <a href="{{url('admin/quotation/create')}}" class="btn btn-warning text-white btn-sm"><i
                                  ...
                                  @foreach($data as $key => $value)
                                        <tr>
                                            ...
                                            <td class="d-flex justify-content-center">
                                                <a href="{{route('admin.quotation.edit',$value->id)  }}" class=" text-success  btn-xs ml-3" title="Edit Testimonila"><i
                                                        class="fa fa-edit"></i></a>
                                            {!! Form::open(['method' => 'GET','route' => ['admin.quotation.destroy', $value->id],'style'=>'display:inline','class'=>'sa-params'.$value->id.'']) !!}												
    ...
    <div class="modal-dialog">
        <div class="modal-content bg_color">
            ...
            <div class="modal-header">
                <h4 class="modal-title text-white">{{ __('Delete Quotation
 On Database') }}</h4>
            ...
            <!-- Modal body -->
            <form action="{{ url('admin/quotation/destroy')}}" method="post">
                @csrf
