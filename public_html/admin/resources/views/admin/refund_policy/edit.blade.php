                ...
                <div class="col-12 col-md-12">
                    <div class="card card-outline card-orange">
                        <div class="card-header bg-primary">
                            <h3 class="card-title"><i class="fa fa-refresh"></i> &nbsp; Refund & Cancellation Policy </h3>
                          ...
                          {!! Form::model($setting, ['method' => 'PATCH','files' => true,'route' => ['admin.refund_policy.update', $setting->id]]) !!}
                           @csrf
                            <div class="row m-2">
                                <div class="col-md-12 Label_top">
                                    <label for="Username">Refund & Cancellation</label>
                                    <textarea  class="form-control ckeditor" name="refund_policy">{{$setting['refund_policy'] ?? ''}}</textarea>
                		        </div>
