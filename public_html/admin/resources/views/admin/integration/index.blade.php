                ...
                <div class="col-12 col-md-12">
                    ...
                    <div class="card card-outline card-orange">
                        <div class="card-header bg-primary">
                            <h3 class="card-title">
                                <i class="fa fa-address-book-o"></i> &nbsp; {{ __('View Integration') }}
                            </h3>
                            <div class="card-tools">
                                <a href="{{url('admin/integration/create')}}" class="btn btn-warning text-white btn-sm"><i
                                  ...
                                  @foreach($data as $key => $value)
                                    <tr>
                                        ...
                                        <td class="text-left">{!! $value['description'] ?? '' !!}</td>
                                         <td>
                                                @if($value->photo )                                    
                                                <img src="{{ env('IMAGE_SHOW_PATH').'integration/'.$value['photo'] }}" class="img-fluid" style="width: 100px; height:100px" alt="{{$value->photo}}">
                                                @else
                                            ...
                                            <td class="d-flex justify-content-center">
                                                <a href="{{route('admin.integration.edit',$value->id)  }}" class=" text-success  btn-xs ml-3" title="Edit Testimonila"><i
                                                        class="fa fa-edit"></i></a>
                                            {!! Form::open(['method' => 'GET','route' => ['admin.integration.destroy', $value->id],'style'=>'display:inline','class'=>'sa-params'.$value->id.'']) !!}												
    ...
    <div class="modal-dialog">
        <div class="modal-content bg_color">
            ...
            <div class="modal-header">
                <h4 class="modal-title text-white">{{ __('Delete Integration
 On Database') }}</h4>
            ...
            <!-- Modal body -->
            <form action="{{ url('admin/integration/destroy')}}" method="post">
                @csrf
