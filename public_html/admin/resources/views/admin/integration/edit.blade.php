                ...
                <div class="col-12 col-md-12">
                    <div class="card card-outline card-orange">
                        <div class="card-header bg-primary">
                            <h3 class="card-title">
                                <i class="fa fa-bank"></i> &nbsp; Edit Integration

                            </h3>
                            <div class="card-tools">
                                <a href="{{ url('admin/integration') }}" class="btn btn-warning text-white btn-sm">
                                    <i class="fa fa-eye"></i> View
                                </a>
                            </div>
                        </div>
                     {!! Form::model($data, ['method' => 'PATCH', 'files' => true, 'route' => ['admin.integration.update', $data->id]]) !!}
                            <div class="row m-2">
                                <div class="col-md-3">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <img src="{{ env('IMAGE_SHOW_PATH').'integration/'.$data['photo'] }}" class="img-fluid" style="width: 100%;" alt="{{$data->photo}}" value="{{old('photo') ?? $data['photo'] }}">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-12">
