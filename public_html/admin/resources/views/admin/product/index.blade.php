...
') }}
                            ...
                            <div class="card-tools">
                                <a href="{{url('admin/product/create')}}" class="btn btn-warning text-white btn-sm"><i
                                ...
                                <table id="example1" class="table table-bordered table-striped dataTable dtr-inline text-center">
                                  ...
                                  @foreach($data as $key => $value)
                                   <tr>
                                            ...
                                            <td>
                                                @if($value->photo )                                    
                                                <img src="{{ env('IMAGE_SHOW_PATH').'product/'.$value['photo'] }}" class="img-fluid" style="width: 45%; height: 55px;" alt="{{$value->photo}}">
                                                @else
                                            ...
                                            <td>
                                                @if($value->photo2 )                                    
                                                <img src="{{ env('IMAGE_SHOW_PATH').'backgroundimg/'.$value['photo2'] }}" class="img-fluid" style="width: 45%; height: 55px;" alt="{{$value->photo2}}">
                                                @else
                                                    <img src="{{('https://test-tirupati.tirupati-international.in/admin/public/assets/user.png')}}" class="img-fluid" style="width: 45%;height: 55px;" alt="avatar.png">
                                                @endif
                                            </td>
                                            ...
                                            <td class="d-flex justify-content-center">
                                                <a href="{{route('admin.product.edit',$value->id)  }}" class=" text-success  btn-xs ml-3" title="Edit Testimonila"><i
