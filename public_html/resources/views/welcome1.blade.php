            ...
            <div class="container-fluid relative">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item"
                                        ...
                                        target="_blank" rel="noopener noreferrer"><i class="fa fa-download"></i>Download
                                        Brochure</a></li>
                                <li><a class="dropdown-item"
                        ...
                        <li class=" nav-item ">
                            <a class="nav-link" href="https://www.tirupati-international.in/news_and_updates">News &
                                Updates</a>
                        </li>
                ...
                <ul class="cd-hero__slider">
                    ...
                    <li class="cd-hero__slide js-cd-slide">
                        ...
                        <div class="cd-hero__content cd-hero__content--half-width cd-hero__content--img">
                            ...
                            <img src="{{ asset('assets/images/tirupativdo.gif') }}"
                                style="width:300px; display:block; border:5px solid red;" alt="Tirupati Demo Video">
                    ...
                    <div class="carousel__body">
                        ...
                        <div class="carousel__slider">
                            ...
                            <div class="carousel__slider__item">
                                <div class="item__3d-frame">
                                    <div class="item__3d-frame__box item__3d-frame__box--front">
                                        <img src="http://tirupati-international.in/admin/image/Team/17616445596900900f15093WhatsApp Image 2025-10-28 at 15.10.04.jpeg"
                                            alt="Team Member Image" class="img-fluid">
                                    </div>
                                    <div class="item__3d-frame__box item__3d-frame__box--left"></div>
                                    <div class="item__3d-frame__box item__3d-frame__box--right"></div>
                                    ...
                                    <div class="teamdata">
                                        ...
                                        <ul class="list-unstyled team-card__social">
                                            ...
                                            <li><a href="" target="_blank"><i class="fab fa-linkedin-in"></i></a></li>
                                            <li><a href="" target="_blank"><i class="fab fa-instagram"></i></a></li>
                                            <li><a href="tel:+91-9588271514" target="_blank"><i
                                                        class="fa fa-phone"></i></a></li>
                                            <li><a href="mailto:nishunaruka61@gmail.com"><i
                                                        class="fa fa-envelope"></i></a></li>
                                        </ul>
                                    </div>
                                    ...
                                    <div class="col-12">
                                        <ul class="list-unstyled footer-one__widget__menu text-center">
                                            <li class="wow fadeInLeft"><a
                                                    href="https://www.tirupati-international.in/abouts">About
                                                    Company</a></li>
                                            <li class="wow fadeInLeft"><a
