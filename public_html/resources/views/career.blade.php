			    ...
			    <div class="containers">
    				<div class="row">
    					<div class="col-md-12 col-lg-12">
    						<div class="contact-one__content tcont-left">
                            	...
                            	<p class="carpera wow fadeInLeft">
    							    We’re excited to hear about your interest in joining our team. As a leading provider of cutting-edge HMS (Hotel Management Software) solutions, we pride ourselves on innovation, excellence, and a commitment to delivering top-notch software that transforms the hospitality industry.
    							</p>
    							
    							<p class="carpera wow fadeInLeft">
    							    By filling out the form below, you’ll be taking the first step towards becoming a part of our dynamic and forward-thinking company. We value creativity, expertise, and passion, and we’re always looking for talented individuals to help us drive the future of hotel management technology.
    							</p>
    					...
    					<div class="col-md-12 col-lg-12">
    					    ...
    					    <form action="{{url('career')}}" class="contact" method="post" enctype="multipart/form-data" id="careerForm">
		                     @csrf

							    <h3 class="contact-one__form__title wow fadeInRight">Please provide your details, and our team will be in touch with you soon to discuss potential opportunities.</h3>
		        	            ...
		        	            <div class="row careerdiv">
								    ...
								    <div class="col-md-12 ">
									    <div class="contact-two__input">
										    ...
										    <select class="brd-fs-clr" id="apply_for" name="apply_for" style="width:100%;height:50px;">
                                                ...
                                                <option value="Training &amp; Installation">Training &amp; Installation </option>
    								...
    								<div class="col-md-12">
    									<button type="button" class="cd-hero__btn cd-hero__btn--secondary full-btn carsubtn" id="submitContactBtn" >
    										<span>
    											Send
		            ...
		            <div class="col-md-4 col-lg-4">
                		<div class="card  wow fadeInDown">
                            ...
                            <div class="card-body text-center">
                                ...
                                <a href="{{url('career-jd')}}?id={{ $item->id }}" class="cd-hero__btn cd-hero__btn--secondary full-btn">Job Description</a>
                            </div>
                        </div>
                    </div>
		        @endforeach
...
$(document).ready(function(){
    $("#phone").inputmask("(999) 999-9999");  // US phone mask
});
</script>
