		...
		<div class="containers">
		    ...
		    <div class="row">
		        ...
		        <div class="col-md-5 col-xs-12 col-lg-6 col-sm-12 wow fadeInLeftBig">
		            <a class="image-popup-no-margins" href="http://tirupati-international.in/public/assets/images/doctor2.png">
	                    <img src="http://tirupati-international.in/public/assets/images/doctor2.png" class="img-fluid proscreen" alt="hms">
	                </a>
		        </div>
		        ...
		        <div class="col-md-7 col-xs-1 col-lg-6 col-sm-1 wow fadeInRightBig">
		            <div class="sec-title text-center">
            			...
            			<h3 class="sec-title__title">Tirupati Doctor Pro+</h3>
            		</div>
		            <p class="contpera">Tirupati Doctor pro+  provide complete module of hospital management software. it includes many small modules like for reception, doctor, multispecialty, op-billing, Reports,  registers, refferal, DMS, what's app, payment-gateway&website, mobile app, customizable, multi-user&multi system and role based access control</p>
		        </div>
	...
	<section class="product-section">
	    <div class="containers" >
            <div class="sec-title text-center">
				...
				<h3 class="sec-title__title">Doctor Pro+</h3>
			</div>
        </div>
	        
	    <div class='container-fluid doc-fetr fetrbg'>
