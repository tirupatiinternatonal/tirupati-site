...
$proid = request('id');
$tpro = DB::table('product')->where('page_url', $proid)->first();

$tprodtls = DB::table('product_details')->where('product_id', $tpro->id)->get();
//dd($tprodtls);
...
<style>
		...
		<div class="containers">
		    ...
		    <div class="row">
		        ...
		        <div class="col-md-5 col-xs-12 col-lg-6 col-sm-12 wow fadeInLeftBig">
		            <a class="image-popup-no-margins" href="{{ env('IMAGE_SHOW_PATH').'image/product/'.$tpro->photo }}">
	                    <img src="{{ env('IMAGE_SHOW_PATH').'image/product/'.$tpro->photo }}" class="img-fluid proscreen" alt="hms">
	                </a>
		        </div>
		        ...
		        <div class="col-md-7 col-xs-1 col-lg-6 col-sm-1 wow fadeInRightBig">
		            <div class="sec-title text-center">
            			...
            			<h3 class="sec-title__title">{{ $tpro->heading }}</h3>
            		</div>
		            <p class="contpera">{{ $tpro->description }}</p>
		            <li style="list-style: none;">
		             
						    <a href="{{$tpro->url ?? ''}}" target="_blank" class="a_font" ><i class="fa fa-youtube-play" style="font-size: 50px;color: red;"></i> <span style="text-decoration: underline;">{{$tpro->url ?? ''}}</span></a>
					</li>	
		        </div>
	...
	<section class="product-section">
	    ...
	    <div class='container-fluid uhms-fetr fetrbg' style="background-image: url({{ env('IMAGE_SHOW_PATH').'image/backgroundimg/'.$tpro->photo2 }});">
...
.download-btn-admit {
    ...
    background: linear-gradient(135deg, #fe4f9b 0%, #fe0000 100%);
