		    ...
		    <div class="row">
		        ...
		        <div class="col-md-7 col-xs-1 col-lg-6 col-sm-1 wow fadeInRightBig">
		            <div class="sec-title text-center">
            			...
            			<h3 class="sec-title__title">Tirupati HMS Pro+</h3>
            		</div>
		            <p class="contpera">Tirupati Ultimate HMS pro+  provide complete module of hospital management software. it includes many small modules like for reception, doctor, multispecialty, op-billing, nursing desk,  IP Billing, reports, registers, refferal, inventory, DMS,  what's app, payment-gateway&website, mobile app, customizable, multi-user&multi system and role based access control </p>
		        </div>
	...
	<section class="product-section">
	    <div class="container" >
            <div class="sec-title text-center">
				...
				<h3 class="sec-title__title">HMS Pro+</h3>
			</div>
        </div>
	        
	    <div class='container-fluid hms-fetr fetrbg'>
