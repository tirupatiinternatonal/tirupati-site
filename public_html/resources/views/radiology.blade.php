		...
		<div class="containers">
		    ...
		    <div class="row">
		        ...
		        <div class="col-md-5 col-xs-12 col-lg-6 col-sm-12 wow fadeInLeftBig">
		            <a class="image-popup-no-margins" href="http://tirupati-international.in/public/assets/images/radiology2.png">
	                    <img src="http://tirupati-international.in/public/assets/images/radiology2.png" class="img-fluid proscreen" alt="hms">
	                </a>
		        </div>
		        ...
		        <div class="col-md-7 col-xs-1 col-lg-6 col-sm-1 wow fadeInRightBig">
		            <div class="sec-title text-center">
            			...
            			<h3 class="sec-title__title">Tirupati Radiology Pro+</h3>
            		</div>
		            <p class="contpera">Tirupati Radiology pro+  provide complete module of hospital management software. it includes many small modules like for reception, X-Ray/Radiologist,	Sonologist, MRI/CT Scan, Refferal, Inventory, EMR, Financial reports,  what's app, payment-gateway&website, mobile app, customizable, multi-user&multi system and role based access control</p>
		        </div>
	...
	<section class="product-section">
	    <div class="container" >
            <div class="sec-title text-center">
				...
				<h3 class="sec-title__title">Radiology Pro+</h3>
			</div>
        </div>
	        
	    <div class='container-fluid radi-fetr fetrbg'>
	        ...
	        <div class="row">
                ...
                <div class="col-md-4 col-lg-4 col-sm-1 col-xs-1">
	                <div class="feat">
	                    <div class="para">
	                        <h4>X-Ray/Radiologist</h4>
	                        <p>Sample Scan, Access Radiology patient for Test Prepare.</p>
	                    </div>
                    </div>
                </div>
                <div class="col-md-4 col-lg-4 col-sm-1 col-xs-1">
	                <div class="feat">
	                    <div class="para">
	                        <h4>Sonologist</h4>
	                        <p>To Manage Sonography reports with PCPNDT data, USG Report with multiple template based quick report prepare along with USG Image Reports.</p>
	                    </div>
                    </div>
                </div>
                <div class="col-md-4 col-lg-4 col-sm-1 col-xs-1">
	                <div class="feat">
	                    <div class="para">
	                        <h4>MRI/CT Scan</h4>
	                        <p>Integration based Reporting with Diacom Interface.</p>
	                    </div>
                    </div>
                </div><div class="col-md-4 col-lg-4 col-sm-1 col-xs-1">
	                <div class="feat">
	                    <div class="para">
	                        <h4>Referral</h4>
