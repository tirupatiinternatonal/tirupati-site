    ...
    <script type="application/ld+json">
{
  ...
  "contactPoint":[
    ...
    <link rel="icon" type="image/x-icon" href="https://www.tirupati-international.in/favicon.ico">
    <meta charset="UTF-8">
    ...
    <!--<link rel="icon" type="image/png" href="https://www.tirupati-international.in/public/assets/images/favicons/favicon-16x16.png">-->

    <link rel="icon" type="image/png" sizes="32x32" href="public/assets/images/favicons/favicon-16x16.png">

    <link rel="apple-touch-icon"
        href="https://www.tirupati-international.in/public/assets/images/favicons/favicon-16x16.png">
...
<body class="">
    <div id="main-wrapper" class="main-wrapper">
                    ...
                    <div class="thbar d-flex" style="">
                        <ul>
                            <li class="wow bounceInDown" style="display: inline-block;list-style: none;">
                                    ...
                                    <g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                                        ...
                                        <path stroke-dasharray="64" stroke-dashoffset="64"
                                            ...
                                            <animateTransform attributeName="transform"
                                                begin="0.6s;lineMdPhoneCallLoop0.begin+2.6s" dur="0.5s" type="rotate"
                                ...
                                <a style="color:white" href="tel:+91 9588840007"> +919588840007</a>
                            </li>
                            ...
                            <li class="wow bounceInDown" style="display: inline-block;list-style: none;">
                                ...
                                <a style="color:white" href="tel:+91 9929202855"> +919929202855</a>
                            </li>
                            <li style="display: inline-block;list-style: none;">
                                <span>&nbsp;|</span>
                            </li>
                            <li class="wow bounceInDown" style="display: inline-block;list-style: none;">
                                <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24">
                                    <path fill="currentColor" fill-opacity="0" d="M12 11L4 6H20L12 11Z">
                                        <animate fill="freeze" attributeName="fill-opacity" begin="1s" dur="0.15s"
                                            values="0;0.3" />
                                    </path>
                                ...
                                <a style="color:white"
                                    href="mailto:info@tirupati-international.in">info@tirupati-international.in</a>
                            </li>


                            <li class="wow bounceInDown" style="display: inline-block;list-style: none;">
                                <a class="image-popup-no-margins"
                                    href="https://www.tirupati-international.in/public/assets/images/qrcode.png">
                                    <div class="cd-hero__btn cd-btn-prim paybtn">
                                        <img class="img-fluid"
                                            src="https://www.tirupati-international.in/public/assets/images/paynow.gif">
                                        <!--<span>-->
                                        <!--Tap to Pay-->
                                        <!--</span>-->
                                    </div>
                            ...
                            <li class="wow bounceInDown" style="display: inline-block;list-style: none;">
                                <a class="" href="https://www.tirupati-international.in/admin/" target="_blank">
                                    <div class="cd-hero__btn cd-btn-prim paybtn">
                                        <img class="img-fluid"
                                            src="https://www.tirupati-international.in/public/assets/images/admin-panel.png">
                                    </div>
                                </a>
                            </li>
                            <!--<li class="wow bounceInDown" style="display: inline-block;list-style: none;">
        ...
        <nav class="navbar navbar-expand-lg sticky-top bg-light tirupati-nav" style='z-index:1000'>
            <div class="container-fluid relative">
                <a href="https://www.tirupati-international.in" class="main-header__logo">
                    <img src="https://www.tirupati-international.in/public/assets/images/logoti.png" alt="">
                    <div class="cnam">Tirupati Software Infotech Pvt. Ltd.</div>
                </a>
                <button class="navbar-toggler tirupati-navmob" type="button" data-bs-toggle="collapse"
                    ...
                    <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li class=""><a class="dropdown-item"
                                        href="https://www.tirupati-international.in/abouts"><i
                                            class="fa fa-info-circle"></i>About Us</a></li>
                                <li class=""><a class="dropdown-item"
                                        href="https://www.tirupati-international.in/overview"><i
                                            class="fa fa-eye"></i>Overview</a></li>
                                <li class=""><a class="dropdown-item"
                                        href="https://www.tirupati-international.in/team"><i class="fa fa-users"></i>Our
                                        Team </a></li>
                                <li class=""><a class="dropdown-item"
                                        href="https://www.tirupati-international.in/career"><i
                                            class="fa fa-graduation-cap"></i>Career</a></li>
                                <li class=""><a class="dropdown-item"
                                        href="https://www.tirupati-international.in/gallery"><i
                                            class="fa fa-images"></i>Gallery</a></li>
                                <li class="" style="display:none;"><a class="dropdown-item"
                                        href="https://www.tirupati-international.in/certificate"><i class="fa fa-award"
                                            style="padding:10px;color:#00accc;display:none;"></i>Certificate</a></li>
                                <li class="" style="display:none;"><a class="dropdown-item"
                                        href="https://www.tirupati-international.in/culture"><i
                                            class="fa fa-house"></i>Culture</a></li>
                                <li class=""><a class="dropdown-item"
                                        href="https://www.tirupati-international.in/events_expo"><i
                                            class="fa fa-calendar-alt"></i>Event / Expo</a></li>
                                <!--<li class=""><a class="dropdown-item" href="https://www.tirupati-international.in/public/assets/images/OFFICE_CRICULAR.pdf" target="_blank"><i class="fa fa-bookmark"></i>Office Circulars</a></li>-->
                                <li class="">
                                    <a class="dropdown-item"
                                        href="http://tirupati-international.in/admin//image/document/176518715869369e56d21d7.pdf"
                                        target="_blank">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="">
                                    <a class="dropdown-item"
                                        href="https://www.tirupati-international.in/product?id=ultimate-hms-pro">
                                        <i class="fa fa-stethoscope"></i>
                                        Tirupati Ultimate HMS Pro+
                                    </a>
                                </li>
                                ...
                                <li class="">
                                    <a class="dropdown-item"
                                        href="https://www.tirupati-international.in/product?id=hms-pro">
                                        <i class="fa fa-stethoscope"></i>
                                        Tirupati HMS Pro+
                                    </a>
                                </li>
                                ...
                                <li class="">
                                    <a class="dropdown-item"
                                        href="https://www.tirupati-international.in/product?id=laboratary-pro">
                                        <i class="fa fa-stethoscope"></i>
                                        Tirupati Laboratary Pro+
                                    </a>
                                </li>
                                ...
                                <li class="">
                                    <a class="dropdown-item"
                                        href="https://www.tirupati-international.in/product?id=radiology-pro">
                                        <i class="fa fa-stethoscope"></i>
                                ...
                                <li class="">
                                    <a class="dropdown-item"
                                        href="https://www.tirupati-international.in/product?id=pharmacy-pro">
                                        <i class="fa fa-stethoscope"></i>
                                        Tirupati Pharmacy Pro+
                                    </a>
                                </li>
                                ...
                                <li class="">
                                    <a class="dropdown-item"
                                        href="https://www.tirupati-international.in/product?id=doctor-pro">
                                        <i class="fa fa-stethoscope"></i>
                                        Tirupati Doctor Pro+
                                    </a>
                                </li>
                                ...
                                <li class="">
                                    <a class="dropdown-item"
                                        href="https://www.tirupati-international.in/product?id=blood-bank-pro">
                                        <i class="fa fa-stethoscope"></i>
                                        Tirupati Blood Bank Pro+
                                    </a>
                                </li>
                                ...
                                <li class="">
                                    <a class="dropdown-item"
                                        href="https://www.tirupati-international.in/product?id=ayurvedic-pro">
                                        <i class="fa fa-stethoscope"></i>
                                        Tirupati Ayurvedic Pro+
                                    </a>
                                </li>
                                ...
                                <li class="">
                                    <a class="dropdown-item"
                                        href="https://www.tirupati-international.in/product?id=ac-software">
                                        <i class="fa fa-stethoscope"></i>
                                        Customized A/c Software
                                    </a>
                                </li>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item"
                                        href="https://www.tirupati-international.in/public/assets/images/Tirupati_HIMS_PPT.pdf"
                                        target="_blank" rel="noopener noreferrer"><i class="fa fa-download"></i>
                                        Brochure</a></li>
                                <li><a class="dropdown-item"
                                        href="https://www.indiamart.com/tirupati-software-infotech/?pos=1&kwd=tirupati%20software%20full%20hms&tags=||||8042.3813|Price|product|TS"
                                        target="_blank" rel="noopener noreferrer"><i class="fa fa-eye"></i>View
                                        Products</a></li>
                                <li><a class="dropdown-item"
                                        href="https://www.tirupati-international.in/public/assets/images/Price &amp; Tarrif.pdf"
                                        target="_blank" rel="noopener noreferrer"><i class="fa fa-download"></i> Price &
                                        Tarrif</a></li>
                                <li><a class="dropdown-item"
                                        href="https://www.tirupati-international.in/public/assets/images/Tariff in $-USD.pdf"
                                        target="_blank" rel="noopener noreferrer"><i class="fa fa-download"></i> Tarrif
                                        in $-USD</a></li>
                                <li><a class="dropdown-item"
                                        href="https://www.tirupati-international.in/public/assets/images/MoU_PO_Agreement 2025.pdf"
                                        target="_blank" rel="noopener noreferrer"><i class="fa fa-download"></i> MOU &
                                        Agreement</a></li>
                                <li><a class="dropdown-item"
                                        href="https://www.tirupati-international.in/public/assets/images/Tirupati_Software_Brousher.pdf"
                                        target="_blank" rel="noopener noreferrer"><i class="fa fa-download"></i>Tirupati
                                        Software Brocher</a></li>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li class=""><a class="dropdown-item"
                                        href="https://www.tirupati-international.in/privacy_policy"><i
                                            class="fa fa-calendar-plus"></i>Privacy Policy</a></li>
                                <li class=""><a class="dropdown-item"
                                        href="https://www.tirupati-international.in/integration"><i
                                            class="fa fa-briefcase"></i>Integration</a></li>
                                <li class=""><a class="dropdown-item"
                                        href="https://www.tirupati-international.in/refund"><i
                                            class="fa fa-door-open"></i>Refund & Cancellation Policy</a></li>
                                <li class=""><a class="dropdown-item"
                                        href="https://www.tirupati-international.in/terms"><i
                                            class="fa fa-files-medical"></i>Terms & Conditions</a></li>
                                <li class=""><a class="dropdown-item"
                                        href="https://www.tirupati-international.in/shipping"><i
                                            class="fa fa-door-open"></i>Shipping Policy</a></li>
                                ...
                                <li class=""><a class="dropdown-item"
                                        href="https://www.tirupati-international.in/faq"><i
                                            class="fa fa-question"></i>FAQ</a></li>
                                <li class=""><a class="dropdown-item"
                                        href="https://www.tirupati-international.in/book-appointment"><i
                                            class="fa fa-copy"></i>Book An Appointment</a></li>
                                <li class=""><a class="dropdown-item"
                                        href="https://www.tirupati-international.in/diagnostic-report"><i
                                            class="fa fa-stethoscope"></i>Diagnostic Report</a></li>
                                <li class=""><a target="_blank" class="dropdown-item"
                                        href="https://project.tirupatihms.com/hms/patients/login"><i
                                            class="fa fa-sign-in"></i>Patient Portal</a></li>
                            </ul>
                        </li>
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown"
                            ...
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item"
                                        href="https://www.google.com/search?q=tirupati+software+infotech+private+limited&rlz=1C1ONGR_enIN1028IN1028&oq=tirupati+software+zinfotech+&aqs=chrome.0.35i39i355j46i39i175i199j69i57j0i390l2j69i60l3.23364j0j7&sourceid=chrome&ie=UTF-8#lrd=0x396db60dce33c21b:0x486b5abcfd844c5f,1,,,,&scso=_S2rTY663Bfyuz7sP3tS7gAc_55:16.799999237060547"
                                        target="_blank" rel="noopener noreferrer"><i class="fa fa-bell-plus"></i>Client
                                        Review</a></li>
                                <li class=""><a class="dropdown-item"
                                        href="https://www.tirupati-international.in/viewclient"><i
                                            class="fa fa-street-view"></i>View Our Client</a></li>
                                <li class=""><a class="dropdown-item"
                                        href="https://www.tirupati-international.in/viewquotation"><i
                                            class="fa fa-badge-dollar"></i>View Quotation</a></li>
                            </ul>
                        </li>
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown"
                            ...
                            <ul class="dropdown-menu">
                                <li class=""><a class="dropdown-item"
                                        href="https://www.tirupati-international.in/news_and_updates"><i
                                            class="fa fa-newspaper"></i>Latest News</a></li>
                                <li class=""><a class="dropdown-item"
                                        href="https://www.tirupati-international.in/software_updates"><i
                                            class="fa fa-code"></i>Software Updates</a></li>
                            </ul>
                        </li>
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle socials" href="#" role="button" data-bs-toggle="dropdown"
                                aria-expanded="false">
                                <img class="img-fluid"
                                    src="https://www.tirupati-international.in/public/assets/images/social-icon.gif">
                            </a>
                            <ul class="dropdown-menu social-tray">
                                <li class="fb">
                                    <a class="dropdown-item" href="https://www.facebook.com/TirupatiSoftware"
                                        target="_blank" rel="noopener noreferrer">
                                        <img class="img-fluid"
                                            src="https://www.tirupati-international.in/public/assets/images/facebook.png">
                                        Facebook
                                    </a>
                                </li>
                                <li class="tw">
                                    <a class="dropdown-item" href="https://x.com/tirupati_pvt" target="_blank"
                                        rel="noopener noreferrer">
                                        <img class="img-fluid"
                                            src="https://www.tirupati-international.in/public/assets/images/twitter.png">
                                        Twitter
                                    </a>
                                </li>
                                <li class="wa">
                                    <a class="dropdown-item"
                                        href="https://api.whatsapp.com/send/?phone=919588840007&amp;text=+May+I+Help+You%21&amp;type=phone_number&amp;app_absent=0"
                                        target="_blank" rel="noopener noreferrer">
                                        <img class="img-fluid"
                                            src="https://www.tirupati-international.in/public/assets/images/whatsapp.png">
                                        Whatsapp
                                    </a>
                                </li>
                                <li class="in">
                                    <a class="dropdown-item" href="https://www.linkedin.com/in/yogesh9929202855/"
                                        target="_blank" rel="noopener noreferrer">
                                        <img class="img-fluid"
                                            src="https://www.tirupati-international.in/public/assets/images/linkedin.png">
                                        Linkedin
                                    </a>
                                </li>
                                <li class="ins">
                                    <a class="dropdown-item" href="https://www.instagram.com/tirupati_int/"
                                        target="_blank" rel="noopener noreferrer">
                                        <img class="img-fluid"
                                            src="https://www.tirupati-international.in/public/assets/images/instagram.png">
                                        Instagram
                                    </a>
                                </li>
                                <li class="im">
                                    <a class="dropdown-item"
                                        href="https://www.indiamart.com/tirupati-software-infotech/" target="_blank"
                                        rel="noopener noreferrer">
                                        <img class="img-fluid"
                                            src="https://www.tirupati-international.in/public/assets/images/indiamart.png">
                                        Indiamart
                                    </a>
                                </li>
                                <li class="yt">
                                    <a class="dropdown-item"
                                        href="https://www.youtube.com/@TirupatiSoftwareInfotechPvtLtd" target="_blank"
                                        rel="noopener noreferrer">
                                        <img class="img-fluid"
                                            src="https://www.tirupati-international.in/public/assets/images/youtube.png">
                                        Youtube
                                    </a>
                                </li>
                                <li class="td">
                                    <a class="dropdown-item" href="https://www.threads.net/@tirupatisoftware"
                                        target="_blank" rel="noopener noreferrer">
                                        <img class="img-fluid"
                                            src="https://www.tirupati-international.in/public/assets/images/thread.png">
                                        Threads
                                    </a>
                                </li>
                                <li class="td">
                                    <a class="dropdown-item" href="https://www.tirupati-international.in/googleReview"
                                        target="_blank" rel="noopener noreferrer">
                                        <img class="img-fluid"
                                            src="https://www.tirupati-international.in/public/assets/images/google.png">
                                        Google Review
                                    </a>
                                </li>
                            </ul>
                        ...
                        <li>
                            <div class="dropdown flagbox">
                                <button class="btn dropdown-toggle flagbtn" type="button" id="dropdownMenuButton1"
                                    data-bs-toggle="dropdown" aria-expanded="false">
                                    <span class="fi fi-in me-1"></span>
                                </button>
                                <ul class="dropdown-menu flag-menu" aria-labelledby="dropdownMenuButton1">
                                    <li>
                                        <a class="dropdown-item flag-item active" href="#"><span
                                                class="fi fi-in me-1"></span></a>
                                    </li>
                                    <li>
                                        <a class="dropdown-item flag-item" href="#"><span
                                                class="fi fi-ng me-1"></span></a>
                                    </li>
                                    <li>
                                        <a class="dropdown-item flag-item" href="#"><span
                                                class="fi fi-ca me-1"></span></a>
                                    </li>
                                    <li>
                                        <a class="dropdown-item flag-item" href="#"><span
                                                class="fi fi-ke me-1"></span></a>
                                    </li>
                                </ul>
                            </div>
        ...
        <head>
            ...
            <!-- Google tag (gtag.js) -->
            <script async src="https://www.googletagmanager.com/gtag/js?id=AW-687284024"></script>
            <script> window.dataLayer = window.dataLayer || []; function gtag() { dataLayer.push(arguments); } gtag('js', new Date()); gtag('config', 'AW-687284024'); </script>
            <!-- End Google Tag Manager -->
            </script>
            <!-- Event snippet for Enquiry From Google for your Product conversion page -->
            <script> gtag('event', 'conversion', { 'send_to': 'AW-687284024/V9VoCIP21eUYELi-3McC', 'value': 1.0, 'currency': 'INR' }); </script>
        </head>
        ...
        <style>
            ...
            @keyframes example {
                0% {
                    transition: transform 1.16s ease-in-out;
                }
        ...
        <body>
            ...
            <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-WX9ZHKX" height="0" width="0"
                ...
                <ul class="cd-hero__slider">
                    <li class="cd-hero__slide cd-hero__slide--selected js-cd-slide">
                        <div class="cd-hero__content cd-hero__content--full-width">
                            ...
                            <a href="https://www.tirupati-international.in/abouts"
                                class="cd-hero__btn cd-btn-prim wow fadeIn" data-wow-duration="4s">
                                Explore
                                <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24">
                                    <g transform="translate(24 0) scale(-1 1)">
                                        <g fill="none" stroke="currentColor" stroke-dasharray="10"
                                            stroke-dashoffset="10" stroke-linecap="round" stroke-linejoin="round"
                                            stroke-width="2">
                    ...
                    <li class="cd-hero__slide js-cd-slide">
                        <div class="cd-hero__content cd-hero__content--half-width">
                            ...
                            <a href="https://api.whatsapp.com/send/?phone=919588840007&amp;text=+May+I+Help+You%21&amp;type=phone_number&amp;app_absent=0"
                                target="_blank" class="cd-hero__btn cd-btn-prim">
                                <span>
                                    Book a Demo
                        ...
                        <div class="cd-hero__content cd-hero__content--half-width cd-hero__content--img">
                            ...
                            <img class="monitorgifbg"
                                src="https://www.tirupati-international.in/public/assets/images/tirupativdo.gif"
                                alt="Tirupati Demo Video">
                    ...
                    <li class="cd-hero__slide js-cd-slide">
                        <div class="cd-hero__content cd-hero__content--half-width cd-hero__content--img">
                            <img src="https://www.tirupati-international.in/public/assets/images/heroslider/mobapp.png"
                                alt="Mobile App">
                        </div> <!-- .cd-hero__content -->
                    ...
                    <li class="cd-hero__slide cd-hero__slide--video js-cd-slide">
                        <div class="cd-hero__content cd-hero__content--full-width">
                            ...
                            <a href="https://www.tirupati-international.in/about"
                                class="cd-hero__btn cd-hero__btn--secondary">
                                <span>
                                    Learn More
                                </span>
                        ...
                        <div class="overlay-bg overlay"></div>
                        <div class="cd-hero__content cd-hero__content--bg-video js-cd-bg-video"
                            data-video="https://www.tirupati-international.in/public/assets/images/heroslider/it-vdo">
                    ...
                    <li class="cd-hero__slide js-cd-slide">
                        <div class="cd-hero__content cd-hero__content--full-width">
                            ...
                            <a href="https://www.tirupati-international.in/abouts" class="cd-hero__btn cd-btn-prim">
                                <span>
                                    Learn More
                                </span>
                            </a>
                    ...
                    <li class="cd-hero__slide js-cd-slide">
                        <div class="cd-hero__content cd-hero__content--full-width">
                            <h2>Database</h2>
                            <p>Using database technology to gather, store and process information can give your business
                    ...
                    <div class="row gutter-y-30" style="--bs-gutter-x: 30px;">
                        ...
                        <div class="col-6 col-md-6 col-lg-6 col-xl-3 p-0">
                            <div class="funfact-one__card">
                                ...
                                <i class="funfact-one__card__icon flaticon-money-bag wow fadeIn"
                        ...
                        <div class="col-6 col-md-6 col-lg-6 col-xl-3 p-0">
                            <div class="funfact-one__card">
                                ...
                                <i class="funfact-one__card__icon flaticon-community wow fadeIn"
                                    data-wow-duration="4s"></i>
                        ...
                        <div class="col-6 col-md-6 col-lg-6 col-xl-3 p-0">
                            <div class="funfact-one__card">
                                ...
                                <i class="funfact-one__card__icon flaticon-target wow fadeIn"
                                    data-wow-duration="4s"></i>
                        ...
                        <div class="col-6 col-md-6 col-lg-6 col-xl-3 p-0">
                            <div class="funfact-one__card">
                                ...
                                <i class="funfact-one__card__icon flaticon-success wow fadeIn"
                                    data-wow-duration="4s"></i>
    ...
    s371.981,38.998,575.971,0s293.985-39.278,505.474,5.859s493.475,48.368,716.963-4.995v560.106H-363.852V502.589z" />
            ...
            <section class="team-section">
                <h2>Aayushman Bharat Digital Mission (ABHA/ABDM Enabled)</h2>
        ...
        <div class="team-card">
                    ...
                    <div class="row gutter-y-60">
                        <div class="col-md-12 col-lg-4 offset-lg-1">
                            <div class="tirupati-owner">
                                <img src="https://www.tirupati-international.in/public/assets/images/yogeshsir_newphoto.jpeg"
                                    style="width: 100%;height: 98%;" class="wow fadeInLeft" data-wow-duration="4s"
                                    alt="Director Sir">
                                <!--<img src="https://www.tirupati-international.in/public/assets/images/yogeshsir.jpeg" style="width: 100%;" class="wow fadeInLeft" data-wow-duration="4s" alt="Director Sir">-->
                        ...
                        <div class="col-md-12 col-lg-6 d-flex">
                            <div class="about-five__content">
                                <div class="sec-title text-start">
                                    <p class="sec-title__tagline wow fadeInRight" data-wow-duration="4s">About company
                                    </p>
                                    <h3 class="sec-title__title">Best Healthcare Solution
                                        provider since 2014</h3>
                                </div>
                                <div class="about-five__content__text">
                                    Welcome to Tirupati Software Infotech Pvt. Limited, a leading innovator in hospital
                                    management software since 2014. With over a decade of experience and a robust
                                    portfolio of more than 60 integrated modules, we specialize in delivering
                                    comprehensive solutions tailored to meet the diverse needs of healthcare facilities.
                                    Our software suite covers essential areas such as Outpatient Department (OPD),
                                    Inpatient Department (IPD), Pharmacy, Radiology, Laboratory, E-Prescription, Medical
                                    Sales, Nursing Desk, and Operation Theatre (OT) management...
                                    <!--<p>-->
                                ...
                                <a href="https://www.tirupati-international.in/about"
                                    class="cd-hero__btn cd-btn-prim mt-5 wow fadeInRight">
                                    Explore More
                                    <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em"
                                        viewBox="0 0 24 24">
                                        <g transform="translate(24 0) scale(-1 1)">
                                ...
                                <div class="service-card-four">
                                    ...
                                    <div class="service-card-four__content">
                                        ...
                                        <div class="serv-card-icon">
                                            <img class="service-card-four__icon"
                                                src="https://www.tirupati-international.in/public/assets/images/coding.png"
                                                alt="Coding Image" style="height:70px; width:60px">
                                            <div class="service-card-four__circle"></div>
                                        </div>

                                        <h3 class="service-card-four__title"><a
                                                href="https://www.tirupati-international.in/ultimatehms">Tirupati
                                                Ultimate HMS Pro+</a></h3>

                                        <p class="service-card-four__text">Fully Integrated HMS Software with 50+
                                            Modules & Features...</p>

                                        <div class="card-read-link">
                                            <a href="https://www.tirupati-international.in/ultimatehms"
                                                class="service-card-four__link">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em"
                                                    viewBox="0 0 256 256">
                                        ...
                                        <a href="https://www.tirupati-international.in/product?id=ultimate-hms-pro"
                                            class="cd-hero__btn cd-hero__btn--secondary full-btn" target="">
                                            Read More
                                            <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em"
                                                viewBox="0 0 24 24">
                                                <g transform="translate(24 0) scale(-1 1)">
                            ...
                            <div class="col-md-6 col-lg-3 wow fadeInLeftBig">
                                <div class="service-card-four">
                                    ...
                                    <div class="service-card-four__content">
                                        ...
                                        <div class="serv-card-icon">
                                            <img class="service-card-four__icon"
                                                src="https://www.tirupati-international.in/public/assets/images/medical-team.png"
                                                alt="Team Image" style="height:70px; width:60px">
                                            <div class="service-card-four__circle"></div>
                                        </div>

                                        <h3 class="service-card-four__title"><a
                                                href="https://www.tirupati-international.in/hms">Tirupati
                                                HMS<br>Pro+</a></h3>

                                        <p class="service-card-four__text">To enhance Hospital OPD & IPD management work
                                            with this software</p>

                                        <div class="card-read-link">
                                            <a href="https://www.tirupati-international.in/hms"
                                                class="service-card-four__link">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em"
                                                    viewBox="0 0 256 256">
                                                    <path fill="currentColor"
                                        ...
                                        <a href="https://www.tirupati-international.in/product?id=hms-pro"
                                            class="cd-hero__btn cd-hero__btn--secondary full-btn" target="">
                                            Read More
                                            <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em"
                                                viewBox="0 0 24 24">
                            ...
                            <div class="col-md-6 col-lg-3 wow fadeInRightBig">
                                <div class="service-card-four">
                                    ...
                                    <div class="service-card-four__content">
                                        ...
                                        <div class="serv-card-icon">
                                            <img class="service-card-four__icon"
                                                src="https://www.tirupati-international.in/public/assets/images/laboratory.png"
                                                alt="Laboratory Image" style="height:70px; width:60px">
                                            <div class="service-card-four__circle"></div>
                                        </div>

                                        <h3 class="service-card-four__title"><a
                                                href="https://www.tirupati-international.in/lab">Tirupati Laboratory
                                                Pro+</a></h3>

                                        <p class="service-card-four__text">Advanced Laboratory Systems for Pathology
                                            Centre</p>

                                        <div class="card-read-link">
                                            <a href="https://www.tirupati-international.in/lab"
                                                class="service-card-four__link">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em"
                                                    viewBox="0 0 256 256">
                                                    <path fill="currentColor"
                                        ...
                                        <a href="https://www.tirupati-international.in/product?id=laboratary-pro"
                                            class="cd-hero__btn cd-hero__btn--secondary full-btn" target="">
                                            Read More
                                            <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em"
                                                viewBox="0 0 24 24">
                            ...
                            <div class="col-md-6 col-lg-3 wow fadeInRightBig">
                                ...
                                <div class="service-card-four">
                                    ...
                                    <div class="service-card-four__content">
                                        ...
                                        <div class="serv-card-icon">
                                            <img class="service-card-four__icon"
                                                src="https://www.tirupati-international.in/public/assets/images/microscope.png"
                                                alt="Microscope Image" style="height:70px; width:60px">
                                            <div class="service-card-four__circle"></div>
                                        </div>

                                        <h3 class="service-card-four__title"><a
                                                href="https://www.tirupati-international.in/radiology">Tirupati
                                                Radiology Pro+ </a></h3>

                                        <p class="service-card-four__text">Complete Radiology Digital system for X-Ray,
                                            USG, MRI, CT-Scan etc</p>

                                        <div class="card-read-link">
                                            <a href="https://www.tirupati-international.in/radiology"
                                                class="service-card-four__link">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em"
                                                    viewBox="0 0 256 256">
                                                    <path fill="currentColor"
                                        ...
                                        <a href="https://www.tirupati-international.in/product?id=radiology-pro"
                                            class="cd-hero__btn cd-hero__btn--secondary full-btn" target="">
                                            Read More
                                            <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em"
                                                viewBox="0 0 24 24">
            ...
            <section class="section-achiev mob-hide">
                <div class="containers">
                    ...
                    <ul class="tirusteps">
                        <li class="manclimbing wow fadeInLeftBig" data-wow-duration="4s"><img
                                src="https://www.tirupati-international.in/public/assets/images/manclimbing.png"
                                alt="Manclimbing Image"></li>
                ...
                <div class="containers">
                    ...
                    <ul class="tiru-mob-steps">
                        ...
                        <li>
                            ...
                            <p class="wow fadeInUp" data-wow-duration="4s">Upgarded to Tirupati Software Infotech Pvt.
                                Ltd.</p>
                        </li>
                        <li>
                        ...
                        <li>
                            ...
                            <p class="wow fadeInUp" data-wow-duration="4s">Company established with vision of healthcare
                                IT services</p>
                        </li>
                    </ul>
                </div>
                    ...
                    <div class="row">
                        <div class="col-md-12 text-center">
                            <div class="funfact-one__info">
                                ...
                                <div class="dl1">
                                    <img class="img-fluid"
                                        src="https://www.tirupati-international.in/public/assets/images/dl.png"
                                        alt="Other Image">
                                </div>
                                ...
                                <div class="wow zoomIn" data-wow-duration="2s">
                                    <a href="https://www.tirupati-international.in/viewquotation"
                                        class="cd-hero__btn cd-hero__btn--secondary mt-5 wow fadeInRight">
                                        Explore
                                        <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em"
                                            viewBox="0 0 24 24">
                                            <g transform="translate(24 0) scale(-1 1)">
            ...
            <section class="section-ourteam">
                ...
                <div class="container">
                    ...
                    <div class="sec-title text-center">
                        ...
                        <h3 class="sec-title__title">With over 10+ years of combined experience,<br />we've got a
                            well-seasoned team.</h3>
                    </div>
                    ...
                    <div class="carousel__body">
                        ...
                        <div class="carousel__slider">
                            ...
                            <div class="carousel__slider__item">
                                <div class="item__3d-frame">
                                    <div class="item__3d-frame__box item__3d-frame__box--front">
                                        <img src="http://tirupati-international.in/admin/image/Team/176432611669297ae4161e9IMG_1606.jpeg"
                                            alt="Team Member Image" class="img-fluid">
                                    </div>
                                    ...
                                    <div class="teamdata">
                                        <div class="tmbx">
                                            <h3>Mrs. Swati Lohar</h3>
                                            <p>Managing Director - Accounts &amp; Administration</p>
                                        </div>
                                        <ul class="list-unstyled team-card__social">
                                            <li><a href="https://www.facebook.com/SWATI03081987" target="_blank"><i
                                                        class="fab fa-facebook-f"></i></a></li>
                                            <li><a href="" target="_blank"><i class="fab fa-twitter"></i></a></li>
                                            <li><a href="https://www.linkedin.com/company/tirupati-software-infotech-pvt-ltd/"
                                                    target="_blank"><i class="fab fa-linkedin-in"></i></a></li>
                                            <li><a href="https://www.instagram.com/swati03081987/" target="_blank"><i
                                                        class="fab fa-instagram"></i></a></li>
                                            <li><a href="tel:+91 94627 02855" target="_blank"><i
                                                        class="fa fa-phone"></i></a></li>
                                            <li><a href="mailto:tirupatiinternational777@gmail.com"><i
                            ...
                            <div class="carousel__slider__item">
                                <div class="item__3d-frame">
                                    <div class="item__3d-frame__box item__3d-frame__box--front">
                                        <img src="http://tirupati-international.in/admin/image/Team/17616492306900a24e7c6e4176164331669008b34caed9IMG_1112.jpeg"
                                            alt="Team Member Image" class="img-fluid">
                                    </div>
                                    <div class="item__3d-frame__box item__3d-frame__box--left"></div>
                                    <div class="item__3d-frame__box item__3d-frame__box--right"></div>
                                    ...
                                    <div class="teamdata">
                                        <div class="tmbx">
                                            <h3>Mr. Yogesh Kumar Lohar</h3>
                                            <p>Managing Director- IT &amp; Administration</p>
                                        </div>
                                        <ul class="list-unstyled team-card__social">
                                            <li><a href="https://www.facebook.com/tirupatihms" target="_blank"><i
                                                        class="fab fa-facebook-f"></i></a></li>
                                            <li><a href="https://twitter.com/Yogesh30091987" target="_blank"><i
                                                        class="fab fa-twitter"></i></a></li>
                                            <li><a href="https://www.linkedin.com/company/tirupati-software-infotech-pvt-ltd"
                                                    target="_blank"><i class="fab fa-linkedin-in"></i></a></li>
                                            <li><a href="https://www.instagram.com/tirupatisoftware/" target="_blank"><i
                                                        class="fab fa-instagram"></i></a></li>
                                            <li><a href="tel:+91 95888 40007" target="_blank"><i
                                                        class="fa fa-phone"></i></a></li>
                                            <li><a href="mailto:tirupatiinternational777@gmail.com"><i
                                                        class="fa fa-envelope"></i></a></li>
                                        </ul>
                            ...
                            <div class="carousel__slider__item">
                                <div class="item__3d-frame">
                                    <div class="item__3d-frame__box item__3d-frame__box--front">
                                        <img src="http://tirupati-international.in/admin/image/Team/172466233266cc423c81b71167652267163edb4afe5902sunil_sir.jpg"
                                            alt="Team Member Image" class="img-fluid">
                                    </div>
                                    <div class="item__3d-frame__box item__3d-frame__box--left"></div>
                                    <div class="item__3d-frame__box item__3d-frame__box--right"></div>
                                    ...
                                    <div class="teamdata">
                                        ...
                                        <ul class="list-unstyled team-card__social">
                                            ...
                                            <li><a href="tel:+91 89498 68687" target="_blank"><i
                                                        class="fa fa-phone"></i></a></li>
                                            <li><a href="mailto:tirupatiinternational777@gmail.com"><i
                                                        class="fa fa-envelope"></i></a></li>
                                        </ul>
                            ...
                            <div class="carousel__slider__item">
                                <div class="item__3d-frame">
                                    <div class="item__3d-frame__box item__3d-frame__box--front">
                                        <img src="http://tirupati-international.in/admin/image/Team/175929967568dcc85b651ddcompressed-172466576166cc4fa171e4fjuhi mam.jpg"
                                            alt="Team Member Image" class="img-fluid">
                                    </div>
                                    <div class="item__3d-frame__box item__3d-frame__box--left"></div>
                                    <div class="item__3d-frame__box item__3d-frame__box--right"></div>
                                    ...
                                    <div class="teamdata">
                                        <div class="tmbx">
                                            <h3>Miss Juhi Sharma</h3>
                                            <p>HR &amp; Accounts manager</p>
                                        </div>
                                        <ul class="list-unstyled team-card__social">
                                            <li><a href="https://www.facebook.com/juhi.sharma.182940?mibextid=ZbWKwL"
                                                    target="_blank"><i class="fab fa-facebook-f"></i></a></li>
                                            <li><a href="" target="_blank"><i class="fab fa-twitter"></i></a></li>
                                            <li><a href="https://www.linkedin.com/in/juhi-sharma-a0368825a"
                                                    target="_blank"><i class="fab fa-linkedin-in"></i></a></li>
                                            <li><a href="https://instagram.com/sharmajuhi0816?igshid=OTJlNzQ0NWM="
                                                    target="_blank"><i class="fab fa-instagram"></i></a></li>
                                            <li><a href="tel:+91 98871 22855" target="_blank"><i
                                                        class="fa fa-phone"></i></a></li>
                                            <li><a href="mailto:tirupatiinternational777@gmail.com"><i
                                                        class="fa fa-envelope"></i></a></li>
                                        </ul>
                            ...
                            <div class="carousel__slider__item">
                                <div class="item__3d-frame">
                                    <div class="item__3d-frame__box item__3d-frame__box--front">
                                        <img src="http://tirupati-international.in/admin/image/Team/175929973268dcc894954c5compressed-172467078566cc63411de8aks final.jpg"
                                            alt="Team Member Image" class="img-fluid">
                                    </div>
                                    <div class="item__3d-frame__box item__3d-frame__box--left"></div>
                                    <div class="item__3d-frame__box item__3d-frame__box--right"></div>
                                    ...
                                    <div class="teamdata">
                                        <div class="tmbx">
                                            <h3>Mr. Kuldeep Kumar Rajput</h3>
                                            <p>Sr. Software Developer</p>
                                        </div>
                                        <ul class="list-unstyled team-card__social">
                                            <li><a href="" target="_blank"><i class="fab fa-facebook-f"></i></a></li>
                                            <li><a href="" target="_blank"><i class="fab fa-twitter"></i></a></li>
                                            <li><a href="https://www.linkedin.com/in/kuldeep-rajput-abb290135"
                                                    target="_blank"><i class="fab fa-linkedin-in"></i></a></li>
                                            <li><a href="" target="_blank"><i class="fab fa-instagram"></i></a></li>
                                            <li><a href="tel:+91 99828 49855" target="_blank"><i
                                                        class="fa fa-phone"></i></a></li>
                                            <li><a href="mailto:tirupatiinternational777@gmail.com"><i
                                                        class="fa fa-envelope"></i></a></li>
                                        </ul>
                            ...
                            <div class="carousel__slider__item">
                                <div class="item__3d-frame">
                                    <div class="item__3d-frame__box item__3d-frame__box--front">
                                        <img src="http://tirupati-international.in/admin/image/Team/175929981568dcc8e78126ecompressed-172467027966cc6147acd3bdevendra sir.jpg"
                                            alt="Team Member Image" class="img-fluid">
                                    </div>
                                    <div class="item__3d-frame__box item__3d-frame__box--left"></div>
                                    <div class="item__3d-frame__box item__3d-frame__box--right"></div>
                                    ...
                                    <div class="teamdata">
                                        ...
                                        <ul class="list-unstyled team-card__social">
                                            ...
                                            <li><a href="" target="_blank"><i class="fab fa-linkedin-in"></i></a></li>
                                            <li><a href="" target="_blank"><i class="fab fa-instagram"></i></a></li>
                                            <li><a href="tel:+91 85599 48264" target="_blank"><i
                                                        class="fa fa-phone"></i></a></li>
                                            <li><a href="mailto:tirupatiinternational777@gmail.com"><i
                                                        class="fa fa-envelope"></i></a></li>
                                        </ul>
                        ...
                        <div class="item__3d-frame">
                            <div class="item__3d-frame__box item__3d-frame__box--front">
                                                                    <img src="http://tirupati-international.in/admin/image/Team/17616445596900900f15093WhatsApp Image 2025-10-28 at 15.10.04.jpeg" alt="Team Member Image" class="img-fluid">
                                                            </div>
                          <div class="item__3d-frame__box item__3d-frame__box--left"></div>
                          <div class="item__3d-frame__box item__3d-frame__box--right"></div>
                            ...
                            <div class="teamdata">
                                ...
                                <ul class="list-unstyled team-card__social">
                                    ...
                                    <li><a href="" target="_blank"><i class="fab fa-linkedin-in"></i></a></li>
                                    <li><a href="" target="_blank"><i class="fab fa-instagram"></i></a></li>
                                    <li><a href="tel:+91-9588271514" target="_blank"><i class="fa fa-phone"></i></a></li>
                                    <li><a href="mailto:nishunaruka61@gmail.com"><i class="fa fa-envelope"></i></a></li>
                                </ul>
                            </div> 
                            ...
                            <!--       <div class="item__3d-frame">-->
                            <!--         <div class="item__3d-frame__box item__3d-frame__box--front">-->
                            <!--             <img src="https://www.tirupati-international.in/public/assets/images/team/kuldeep.jpeg" alt="Team Member Image" class="img-fluid">-->
                            <!--         </div>-->
                            <!--         <div class="item__3d-frame__box item__3d-frame__box--left"></div>-->
                            <!--         <div class="item__3d-frame__box item__3d-frame__box--right"></div>-->
                            ...
                            <!--           <img src="https://www.tirupati-international.in/public/assets/images/team/devendra-soni.jpg" alt="Team Member Image" class="img-fluid">-->
                            <!--         </div>-->
                            <!--         <div class="item__3d-frame__box item__3d-frame__box--left"></div>-->
                            <!--         <div class="item__3d-frame__box item__3d-frame__box--right"></div>-->
                ...
                <div class="containers">
                    ...
                    <div class="row">
                        <div class="col-md-12 col-lg-12">
                            ...
                            <form action="https://www.tirupati-international.in/web_form" method="post"
                                class="news wow fadeInUp" data-wow-duration="4s">
                                <input type="hidden" name="_token" value="QJ7lF5gEK4kH6DsHr6tXJ35ABZCYBLCDYWbaJFGp">
                                <input type="text" name="email" id="email" placeholder="Email Address">
                                <button type="submit">
                                    <img src="https://www.tirupati-international.in/public/assets/images/email-ani.gif"
                                        alt="Email Image">
                                </button>
                            </form>
            ...
            <div id="bcklnksts" style="display:none"><a href="http://planetavvs.ru" target="_blank"
                    title="StreamEast">StreamEast</a><a href="https://alanyasmmm.com" target="_blank"
                    title="alanya escort">alanya escort</a><a href="https://konyalilarserametal.com" target="_blank"
                    title="konya escort">konya escort</a><a href="https://unidentifiedenemy.com" target="_blank"
                    title="galabet">galabet</a><a href="https://casibomyeni.store" target="_blank"
                    title="alanya escort">alanya escort</a><a href="https://casibom-girisyeni.com" target="_blank"
                    title="alanya escort">alanya escort</a><a href="https://karite.shop" target="_blank"
                    title="alanya escort">alanya escort</a><a href="https://tr.galabett-hizli-gir.com" target="_blank"
                    title="galabet">galabet</a></div>
    ...
    transform:rotate(360deg);}*/
        ...
        <footer class="footer-two footer-two--home-1" style="background-color#16243e;">
            ...
            <!-- 						         <a href="https://maps.app.goo.gl/gfHTbVqi4tiAYyC3A" target="_blank" >244-A, Ravindra Nagar-A Airport Road, Jagatpura, Teh, Sanganer, Jaipur, Rajasthan 302022</a>-->
            <!--     						 </div>-->
            ...
            <!-- 						     <div class="foot-cntnt">-->
            <!--     							 <i class="far fa-map-marker-alt"></i> -->
            <!--     							 <a href="https://maps.app.goo.gl/3T2DeBxoSsJ2yvxM6" target="_blank" >111-A, Geeta Vihar, Near Maharana Pratap Circle, Pratap Nagar,  Sanganer-302033, Jaipur (Rajasthan) India</a>-->
            <!-- 							 </div>-->
            <!-- 							 <div class="footmapbox">-->
            ...
            <!-- 						     <div class="foot-cntnt">-->
            <!-- 							    <i class="far fa-map-marker-alt"></i> -->
            <!-- 							    <a href="https://maps.app.goo.gl/hYnjYf7V4CCx98x68" target="_blank">Shop No .11, Sikar Road, Sector 2, Radha Govind Colony, Dahar Ka Balaji, Jaipur, Rajasthan 302032</a>-->
            <!-- 							 </div>-->
            <!-- 							 <div class="footmapbox">-->
                    ...
                    <div class="row gutter-y-30">
                        ...
                        <div class="col-md-12 col-lg-6">
                            <div class="footer-two__widget footer-two__widget--about wow fadeInLeft">
                                ...
                                <div class="ftabtlgo">
                                    <img src="https://www.tirupati-international.in/public/assets/images/logoti.png"
                                        alt="" class="foot-logo img-fluid">
                                    <h4 class="cpnam">Tirupati Software Infotech Pvt. Ltd.</h4>
                                </div>

                                <p class="footer-two__widget__text">We manage the tasks, projects and processes that
                                    help organizations to communicate, manage positions or differentiate themselves in
                                    their markets by our experienced of IT & software services.</p>
                                <!-- /.footer-widget__text -->
                                <ul class="list-unstyled footer-two__widget__social">
                                    <li class="fb">
                                        <a href="https://www.facebook.com/TirupatiSoftware" target="_blank">
                                            <i class="fab fa-facebook-f"></i>
                                        </a>
                                    </li>
                                    <li class="tw">
                                        <a href="https://x.com/tirupati_pvt" target="_blank">
                                            <i class="fab fa-twitter"></i>
                                        </a>
                                    </li>
                                    <li class="in">
                                        <a href="https://www.linkedin.com/in/yogesh9929202855/" target="_blank">
                                            <i class="fab fa-linkedin-in"></i>
                                        </a>
                                    </li>
                                    <li class="ins">
                                        <a href="https://www.instagram.com/tirupati_int/" target="_blank">
                                            <i class="fab fa-instagram"></i>
                                        </a>
                                    </li>
                                    <li class="ins">
                                        <a href="https://www.threads.net/@tirupatisoftware" target="_blank">
                                            <div class="threads-icon"></div>
                                        </a>
                                    </li>

                                    <li class="indmrt">
                                        <a href="https://www.indiamart.com/tirupati-software-infotech/" target="_blank">
                                            <div class="indiamart-icon"></div>
                                        </a>
                                    </li>
                                    <li class="ytube">
                                        <a href="https://www.youtube.com/@TirupatiSoftwareInfotechPvtLtd"
                                            target="_blank">
                                    ...
                                    <li class="wapp">
                                        <a href="tel:+91 9929202855" target="_blank">
                                            <i class="far fa-phone-plus"></i>
                                        </a>
                                    </li>
                                    <li class="in">
                                        <a href="mailto:info@tirupati-international.in" target="_blank">
                                ...
                                <ul class="ul_style">
                                    <li class="in li_style">
                                        <a href="https://www.capterra.com/p/142145/Hospital-Management-Software/reviews/"
                                            target="_blank">
                                            <img border="0"
                                                src="https://brand-assets.capterra.com/badge/b7ae069f-5a38-41e9-adac-beb72a7c3133.svg"
                                                / style="width: 100%;">

                                        </a>
                                    </li>
                                    <li class="in li_style">
                                        <a href="https://www.getapp.com/healthcare-pharmaceuticals-software/a/hms-pro/reviews/"
                                            target="_blank">
                                            <img border="0"
                                                src="https://brand-assets.getapp.com/badge/991bc048-8aff-4cec-a3dc-e9fa8c9400b5.png"
                                                / style="height: 50px;width: 100%;">

                                        </a>
                                    </li>
                                    <li class="in li_style">
                                        <a href="https://www.softwareadvice.com/product/468305-Hospital-Management-Software/reviews/"
                                            target="_blank">
                                            <img border="0"
                                                src="https://brand-assets.softwareadvice.com/badge/6210404e-989a-4ec0-b921-417c506dec78.png"
                                                / style="width: 100%;">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        <ul class="list-unstyled footer-one__widget__menu text-center">
                                            <li class="wow fadeInLeft"><a
                                                    href="https://www.tirupati-international.in/about">About Company</a>
                                            </li>
                                            <li class="wow fadeInLeft"><a
                                                    href="https://www.tirupati-international.in/overview">Latest
                                                    Services</a></li>
                                            <li class="wow fadeInLeft"><a
                                                    href="https://www.tirupati-international.in/team">Meet The Team</a>
                                            </li>
                                            <li class="wow fadeInLeft"><a
                                                    href="https://www.tirupati-international.in/career">Need a
                                                    Career?</a></li>
                                        </ul>
                                    </div>
                        ...
                        <div class="col-md-12 col-lg-3">
                            <div class="footer-two__widget footer-two__widget--menu">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        <ul class="list-unstyled footer-one__widget__menu text-center">
                                            <li class="wow fadeInRight"><a
                                                    href="https://www.tirupati-international.in/hms"> HMS Pro+</a></li>
                                            <li class="wow fadeInRight"><a
                                                    href="https://www.tirupati-international.in/radiology">Radilogoy
                                                    Pro+</a></li>
                                            <li class="wow fadeInRight"><a
                                                    href="https://www.tirupati-international.in/lab"> Laboratory
                                                    Pro+</a></li>
                                            <li class="wow fadeInRight"><a
                                                    href="https://www.tirupati-international.in/doctor">Doctor Pro+</a>
                                            </li>
                                            <li class="wow fadeInRight"><a
                                                    href="https://www.tirupati-international.in/pharmacy">Pharmacy
                                                    Pro+</a></li>
                                        </ul>
                                    </div>
            ...
            <div class="footer-two__copyright">
                <div class="container text-center">
                    <p class="footer-two__copyright__text">Copyright &copy; </span> 2023 Tirupati Software InfoTech Pvt.
                        Ltd. ,
...
<script>
    /*$.ajaxSetup({
        ...
        var URL  = "https://www.tirupati-international.in";*/
</script>
